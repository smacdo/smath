...
public:
    ...
    {
        SMATH_ASSERT( NUM_VALUES, "Matrix4 operator[] out of range" );
        return m[offset];
    }
    ...
    {
        SMATH_ASSERT( r < NUM_ROWS, "Matrix row out of range");
        SMATH_ASSERT( c < NUM_COLS, "Matrix column out of range");
    ...
    {
        SMATH_ASSERT( c < NUM_COLS, "Matrix col out of range" );
